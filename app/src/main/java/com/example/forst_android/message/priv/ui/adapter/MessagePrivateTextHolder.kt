...
import com.example.forst_android.databinding.ItemMessagePrivateTextBinding
import com.example.forst_android.message.priv.ui.MessagePrivateItem

class MessagePrivateTextHolder(
    private val binding: ItemMessagePrivateTextBinding
) : MessagePrivateItemHolder(binding.root) {

    fun bind(item: MessagePrivateItem.MessagePrivateText) = binding.apply {
    ...
    companion object {
        fun from(parent: ViewGroup) = MessagePrivateTextHolder(
            ItemMessagePrivateTextBinding.inflate(
