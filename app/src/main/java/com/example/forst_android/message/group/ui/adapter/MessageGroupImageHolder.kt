...
import com.example.forst_android.databinding.ItemMessageGroupImageBinding

class MessageGroupImageHolder(
    private val binding: ItemMessageGroupImageBinding
) : MessageGroupItemHolder(binding.root) {
    fun bind(item: MessageGroupItem.MessageGroupImage) = binding.apply {
    ...
    companion object {
        fun from(parent: ViewGroup) = MessageGroupImageHolder(
            ItemMessageGroupImageBinding.inflate(
